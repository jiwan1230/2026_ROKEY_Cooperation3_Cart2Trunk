...
_m08 = import_module("cart2trunk_planning.core.unloadable_reason")
...
def verify_reason_codes() -> bool:
    ...
    # ⑰ 박스-벽 마진(17_margin_check.MARGIN, main과 병합하며 0.01->0.02로 상향) 도입
...
def verify_coordinate_bounds() -> bool:
    ...
    _m03b = im("cart2trunk_planning.core.extreme_point_candidates")
    placed_boxes = [
...
def verify_scoring_regression() -> bool:
    ...
    _m05 = import_module("cart2trunk_planning.core.candidate_scoring")
    score_candidate = _m05.score_candidate
    _m03b = import_module("cart2trunk_planning.core.extreme_point_candidates")
